...
pub async fn find_all_billable_metric_groups(configuration: &configuration::Configuration, code: &str, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::GroupsPaginated, Error<FindAllBillableMetricGroupsError>> {
    let local_var_configuration = configuration;
...
pub async fn find_all_billable_metrics(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::BillableMetricsPaginated, Error<FindAllBillableMetricsError>> {
    let local_var_configuration = configuration;
