...
pub async fn find_all_applied_coupons(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, status: Option<&str>, external_customer_id: Option<&str>) -> Result<crate::models::AppliedCoupons, Error<FindAllAppliedCouponsError>> {
    let local_var_configuration = configuration;
...
pub async fn find_all_coupons(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::Coupons, Error<FindAllCouponsError>> {
    let local_var_configuration = configuration;
