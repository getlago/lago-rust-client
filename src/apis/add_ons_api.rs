...
pub async fn find_all_add_ons(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<crate::models::AddOnsPaginated, Error<FindAllAddOnsError>> {
    let local_var_configuration = configuration;
