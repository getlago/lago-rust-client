...
pub struct CustomerObject {
    ...
    #[serde(rename = "applicable_timezone", skip_serializing_if = "Option::is_none")]
    pub applicable_timezone: Option<String>,
    ...
    pub metadata: Option<Vec<crate::models::CustomerMetadataObject>>,
}

impl CustomerObject {
    pub fn new(lago_id: uuid::Uuid, external_id: String, sequential_id: i32, slug: String) -> CustomerObject {
        CustomerObject {
            lago_id,
            external_id,
            name: None,
