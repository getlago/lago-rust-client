...
impl AppliedCouponObject {
    pub fn new(lago_id: uuid::Uuid, lago_coupon_id: uuid::Uuid, coupon_code: String, lago_customer_id: uuid::Uuid, external_customer_id: String, status: Status, amount_cents: i32, amount_currency: String, frequency: Frequency, created_at: String) -> AppliedCouponObject {
        AppliedCouponObject {
            lago_id,
            lago_coupon_id,
            coupon_code,
